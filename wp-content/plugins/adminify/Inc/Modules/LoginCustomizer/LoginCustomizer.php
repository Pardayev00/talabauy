...
if ( ! class_exists( 'LoginCustomizer' ) ) {
	...
	class LoginCustomizer {
		...
		public function jltwp_adminify_redirect_customizer() {
			...
			$panels = '';
			if( Utils::is_plugin_active('loginfy/loginfy.php') || Utils::is_plugin_active('loginfy-pro/loginfy.php')  ){
				$panels = 'loginfy_panel';
			} else {
				$panels = 'jltwp_adminify_panel';
			}
		...
		public function jltwp_adminify_login_customizer_submenu() {
			$admin_url = '';
			if( Utils::is_plugin_active('loginfy/loginfy.php') || Utils::is_plugin_active('loginfy-pro/loginfy.php')  ){
				$admin_url = 'customize.php?autofocus[panel]=loginfy_panel';
			} else {
