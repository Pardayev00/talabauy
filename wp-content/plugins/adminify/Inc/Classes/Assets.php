...
class Assets extends AdminSettingsModel {
    ...
    public function __construct() {
        ...
        $this->dark_mode = $this->options['admin_bar_mode'];
    ...
    public function header_scripts() {
        if ( !empty( $this->dark_mode ) && $this->dark_mode == 'dark' ) {
			...
			<style>
				.wp-adminify.adminify-dark-mode .logo-light {
					display: none;
				}

				.wp-adminify.adminify-dark-mode .logo-dark {
    ...
    public function jltwp_adminify_admin_scripts() {
        ...
        wp_register_style(
            ...
            WP_ADMINIFY_ASSETS . 'css/wp-adminify-default-ui.min.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
        ...
        wp_register_script(
            'wp-adminify--dark-mode',
            WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify-dark-mode.js',
            array(),
            WP_ADMINIFY_VER,
            false
        );
