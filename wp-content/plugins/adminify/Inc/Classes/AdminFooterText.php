	...
	public function jltwp_adminify_footer_credits() {    ?>
		<div class="wp-adminify adminify-first-child">
			<div class="wp-adminify--copyright">
				<?php
				echo sprintf( __('Developed by <a href="%1$s" target="_blank" title="WP Adminify by Jewel Theme" target="_blank">%2$s</a> <br>
                        Powered by <a target="_blank" href="%3$s">WordPress</a>', 'adminify'),
