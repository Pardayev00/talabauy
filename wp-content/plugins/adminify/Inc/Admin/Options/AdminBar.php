...
class AdminBar extends AdminSettingsModel {
    ...
    public function admin_bar_style_tab_settings( &$fields ) {
        ...
        $fields[] = [
            ...
            'type'     => 'color_group',
            'title'    => __( 'Dropdown Style', 'adminify' ),
            'subtitle' => __( 'Dropdown Link colors active, hover, background etc ', 'adminify' ),
            'options'  => [
                'wrapper_bg'  => __( 'Dropdown BG', 'adminify' ),
