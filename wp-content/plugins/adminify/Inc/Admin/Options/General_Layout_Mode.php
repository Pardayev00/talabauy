...
class General_Layout_Mode extends AdminSettingsModel {
    ...
    public function layout_mode_setting_fields( &$fields ) {
        ...
        $fields[] = [
            ...
            'fields'     => [
                ...
                [
                    ...
                    'dependency'   => [
                        'admin_bar_logo_type|admin_ui|layout_type|menu_mode',
                        '==|==|==|==',
                        'image_logo|true|vertical|icon_menu',
                        'true'
                    ],
                ]
            ],
        ...
        $fields[] = [
            ...
            'fields'     => [
                ...
                [
                    'id'           => 'mini_admin_bar_dark_logo',
                    'type'         => 'media',
                    'title'        => __( 'Mini Menu Logo', 'adminify' ),
                    'library'      => 'image',
                    'preview_size' => 'thumbnail',
                    'button_title' => __( 'Add Dark Mini Menu Logo', 'adminify' ),
                    'remove_title' => __( 'Remove Dark Mini Menu Logo', 'adminify' ),
                    'default'      => $this->get_default_field( 'admin_bar_dark_mode' )['mini_admin_bar_dark_logo'],
                    'dependency'   => [
                        'admin_bar_logo_type|admin_ui|layout_type|menu_mode',
                        '==|==|==|==',
                        'image_logo|true|vertical|icon_menu',
    ...
    public function general_layout_mode_settings() {
        ...
        \ADMINIFY::createSection( $this->prefix, [
            'title'  => __( 'Dark/Light Mode', 'adminify' ),
            'icon'   => 'fas fa-adjust',
            'fields' => $fields,
        ] );
    }
