...
class Listfoliopro_Video_Popup_Widget extends Widget_Base {

	public function get_name() {

		return 'listfoliopro_video_popup';
	}

	public function get_title() {
		return esc_html__( 'Video Popup', 'listfoliopro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'video_popup_options',
			[
				'label' => esc_html__( 'Video Popup', 'listfoliopro' ),
		...
		$this->add_control(
		    'video_url',
		    [
		        'label'       => __( 'Video URL', 'listfoliopro' ),
		        'label_block'       => true,
        ...
        $this->add_control(
            'enable_overlay',
            [
                'label'     => esc_html__( 'Enable Overlay', 'listfoliopro' ),
		...
		$this->add_responsive_control(
		    'video_height',
		    [
		        'label' => esc_html__( 'Height', 'listfoliopro' ),
		...
		$this->add_responsive_control(
			'btn_size',
			[
				'label' => esc_html__( 'Button Size', 'listfoliopro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
        ...
        $this->add_control(
            'btn_bg_color',
            [
                'label'       => esc_html__('Button Background Color', 'listfoliopro'),
		...
		$this->add_control(
			'btn_color',
			[
				'label'       => esc_html__('Button Color', 'listfoliopro'),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
        ...
        $this->add_control(
            'overlay_color',
            [
                'label'       => esc_html__('Overlay Color', 'listfoliopro'),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
...
Plugin::instance()->widgets_manager->register( new Listfoliopro_Video_Popup_Widget );