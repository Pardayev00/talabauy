<?php
namespace Elementor;
class listfoliopro_Posts_Nomap_Widget extends Widget_Base {

	public function get_name() {

		return 'listfoliopro_post_nomap';
	}

	public function get_title() {
		return esc_html__( 'All Listings: No Map', 'listfoliopro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Listing No Map', 'listfoliopro' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_categories2(),
			]
		);
		$this->add_control(
			'locations',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_locations2(),
			]
		);
		$this->add_control(
			'tag',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_tag2(),
			]
		);
	...
	protected function render() {
		...
		$shortcode ="[listfoliopro_archive_grid_no_map ".$atts." ]";
...
Plugin::instance()->widgets_manager->register( new listfoliopro_Posts_Nomap_Widget );
//Post Category
function ep_listfoliopro_post_categories2() {
...
//Post tag
function ep_listfoliopro_post_tag2() {
	$listfoliopro_directory_url=get_option('listfoliopro_ep_url');
	if($listfoliopro_directory_url==""){$listfoliopro_directory_url='listing';}
...
//Post locations
function ep_listfoliopro_post_locations2() {
	$listfoliopro_directory_url=get_option('listfoliopro_ep_url');
	if($listfoliopro_directory_url==""){$listfoliopro_directory_url='listing';}
