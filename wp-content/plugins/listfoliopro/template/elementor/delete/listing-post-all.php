...
class listfoliopro_Recent_Posts_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'All Listings + Map', 'listfoliopro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Listing: Right Map', 'listfoliopro' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_categories(),			
			]
		);
		$this->add_control(
			'locations',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_locations(),			
			]
		);
		$this->add_control(
			'tag',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listfoliopro_post_tag(),			
			]
		);
	...
	protected function render() {
		...
		$shortcode ="[listfoliopro_archive_grid ".$atts." ]";		
...
//Post Category
function ep_listfoliopro_post_categories() {
...
//Post tag
function ep_listfoliopro_post_tag() {
	$listfoliopro_directory_url=get_option('listfoliopro_ep_url');
	if($listfoliopro_directory_url==""){$listfoliopro_directory_url='listing';}
...
//Post locations
function ep_listfoliopro_post_locations() {
	$listfoliopro_directory_url=get_option('listfoliopro_ep_url');
	if($listfoliopro_directory_url==""){$listfoliopro_directory_url='listing';}
