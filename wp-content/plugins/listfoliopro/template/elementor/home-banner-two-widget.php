...
class Listfoliopro_Home_Banner_Two_Widget extends Widget_Base {

	public function get_name() {
		return 'listfoliopro_home_banner_two';
	}

	public function get_title() {
		return esc_html__( 'Home Banner Two', 'listfoliopro' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( '<h1>Unlock Endless Possibilities in Real Estate</h1>', 'listfoliopro' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::WYSIWYG,
                'default'     => __( '<p>Haven\'t had a chance to explore the latest real estate offerings for a whole 5 minutes! We should catch up on the market trends and see what exciting properties are available in this listihib.</p>', 'listfoliopro' ),
                'label_block' => true,
            ]
        );
	...
	protected function render() {
		...
		<div class="home-banner-one-wrapper home-banner-two bootstrap-wrapper" style="background-image: url(<?php echo esc_url($settings['image']['url']);?>)">
            <div class="container">
                <div class="row">
...
Plugin::instance()->widgets_manager->register( new Listfoliopro_Home_Banner_Two_Widget );