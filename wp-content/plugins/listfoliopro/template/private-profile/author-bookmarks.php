...
?>
<div class="border-bottom pb-15 mb-3 toptitle-sub"><?php esc_html_e('Saqlangan muallif', 'listfoliopro'); ?>	
	</div>	
	...
	<section class="content-main-right list-listings mb-30">
		<div class="list">
			<?php
				$favorites=get_user_meta(get_current_user_id(),'listfoliopro_authorbookmark', true);	
				$favorites_a = array();
				...
				<table id="all-bookmark" class="table tbl-epmplyer-bookmark" >
					<thead>
						<tr class="">
							<th><?php  esc_html_e('Sarlavha','listfoliopro');?></th>
						</tr>
					</thead>
					<?php
						$i=0;
									...
									<div class="row align-items-center">
											...
											<div class="img-listing text-center circle">												
												<a href="<?php  echo esc_url($page_link); ?>">
													...
													<?php
														...
														echo'<img class="img-fluid" src="'. esc_url(listfoliopro_ep_URLPATH.'assets/images/Blank-Profile.jpg').'" class="rounded-logo" >';
													}
												?>
												</a>
											</div>
										...
										<div class="col-md-10 listing-info px-0">
											<div class="text px-0 text-left">
												...
												<div class="location"><span> <?php esc_html_e('Open listings', 'listfoliopro'); ?></span>:<span class="p-2"> <?php echo esc_html($main_class->listfoliopro_total_listing_count($user_id, $allusers='no' )); ?></span>
												</div>
												...
												<div class="group-button mt-2">	
													<button class="btn btn-small-ar" onclick="listfoliopro_author_email_popup('<?php echo esc_html(trim($user_id));?>')" ><i class="far fa-envelope"></i></button>
													<button class="btn btn-small-ar" onclick="listfoliopro_company_bookmark_delete_myaccount('<?php echo esc_html($user_id);?>','companybookmark')"><i class="far fa-trash-alt"></i></button>
												</div>
											</div>
										</div>
									</div>
