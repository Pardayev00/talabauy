												...
												<div class="text px-0 text-left">
													...
													<div class="group-button mt-2">	
														<?php
															...
															?>
															<button class="btn btn-small-ar" onclick="listfoliopro_listing_email_popup('<?php echo esc_html(trim($user_id));?>')" ><i class="far fa-envelope"></i></button>
															<?php
															}
														?>
														<button class="btn btn-small-ar" onclick="listfoliopro_listing_bookmark_delete_myaccount('<?php echo esc_html($user_id);?>','listingbookmark')"><i class="far fa-trash-alt"></i></button>
													</div>
												</div>
											</div>
										</div>
