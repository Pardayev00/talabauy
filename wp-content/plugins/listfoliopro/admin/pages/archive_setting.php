							...
							<div class="row">
								<div class="col-md-12 col-lg-6">
									...
									if( $field_key!='category' AND $field_key!='top_search_form'){
										?>	
										<button type="button" class=" btn-icon mb-1" onclick="listfoliopro_icon_uploader('field_icon<?php echo esc_attr($i); ?>');"><?php esc_html_e('Icon','listfoliopro'); ?></button>
									<?php
									}
									?>
								</div>
								<div class="col-md-12 col-lg-6">															
										...
										if( $field_key=='category'){
											?>									
											<input type="text" name="field_icon[]" id="field_icon<?php echo esc_attr($i); ?>"  readonly class="form-control"   value="<?php esc_html_e('Collect from category','listfoliopro'); ?>" />								
										<?php
