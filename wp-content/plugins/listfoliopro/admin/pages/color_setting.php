...
<form class="form-horizontal" role="form"  name='color_settings' id='color_settings'>	
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Big Button','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
...
?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Font: Big Button','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
...
?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Small Button','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
	...
	<?php
	$button_font_color=get_option('listfoliopro_button_small_font_color');	
	if($button_font_color==""){$button_font_color='#ffffff';}	
?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Font: Small Button','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
	...
	?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Icon','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
	...
	?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Title','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
	...
	?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Content Font','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
	...
	?>
	<div class="form-group row">
		<label  class="col-md-4 control-label"> <?php esc_html_e('Border','listfoliopro');  ?>		
		</label>
		<div class="col-md-8">																		
