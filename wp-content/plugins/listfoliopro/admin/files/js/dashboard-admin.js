...
function listfoliopro_tabopen(evt, tabname) {
...
function listfoliopro_update_openai_settings(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#update_myaccount_menu-message").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_update_openai_settings",
...
function listfoliopro_update_myaccount_menu(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#update_myaccount_menu-message").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_update_myaccount_menu",
...
function listfoliopro_update_single_fields(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#success_message-single-fields").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_update_single_fields",
...
function listfoliopro_update_archive_fields(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#success_message-archive-fields").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_update_archive_fields",
...
function listfoliopro_update_search_fields(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#success_message-search-fields").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_update_search_fields",
...
function listfoliopro_remove_saved_shortcode(deletid){
	"use strict";
	
	jQuery('#searchshortcode'+deletid).remove();
		setTimeout(function(){			
			var search_params={
					"action"  	: 	"listfoliopro_search_shortcodes_saved_delete",
...
function listfoliopro_create_search_shortcode(){
	"use strict";
	var loader_image = admindata.loading_image;
	jQuery("#create_search_shortcode_update_message").html(loader_image);
	var search_params={
		"action"  : 	"listfoliopro_create_search_shortcode",
		"form_data":	jQuery("#search_active_fields").serialize(), 
		"_wpnonce": 	admindata.settings,
	};
	jQuery.ajax({					
...
function iv_update_mailchamp_settings(){
	"use strict";
	var search_params={
		"action"  : 	"listfoliopro_update_mailchamp_setting",
...
function iv_create_home_page(){
	"use strict";
	var search_params={
		"action"  : 	"listfoliopro_add_home_page",
		"_wpnonce": 	admindata.settings,
	};
	jQuery.ajax({					
		url : ajaxurl,					 
...
function listfoliopro_delete_feature_field(id_delete){
	"use strict";
	jQuery('#feature_'+id_delete).remove();
}
function listfoliopro_add_feature_field(){
	"use strict";
...
function listfoliopro_import_demo(){
	"use strict";
	...
	var search_params={
			"action"  : "listfoliopro_import_data",
			"_wpnonce": 	admindata.settings,
		};
		jQuery.ajax({					
			url : ajaxurl,					 
...
function listfoliopro_update_user_setting() {
	"use strict";
				// New Block For Ajax*****
			var search_params={
				"action"  : 	"listfoliopro_update_user_settings",
...
function listfoliopro_update_color_settings(){
	"use strict";
		var loader_image = admindata.loading_image;
		jQuery("#success_message_color_setting").html(loader_image);
		var search_params={
				"action"  : 	"listfoliopro_update_color_settings",
...
function listfoliopro_update_map_settings(){
		"use strict";
		var loader_image = admindata.loading_image;
		jQuery("#success_message_map_setting").html(loader_image);
		var search_params={
				"action"  : 	"listfoliopro_update_map_settings",
...
function update_stripe_setting() {
				...
				var ajaxurl = admindata.ajaxurl;
				var search_params={
					"action"  : 	"listfoliopro_update_stripe_settings",
...
function listfoliopro_update_payment_settings_terms() {
				"use strict";
				// New Block For Ajax*****
				var search_params={
					"action"  : 	"listfoliopro_update_payment_setting",
...
function listfoliopro_update_page_settings(){
				"use strict";
				jQuery("#page_all_setting_save").html(loader_image);
				var search_params={
					"action"  : 	"listfoliopro_update_page_setting",
					"form_data":	jQuery("#listfoliopro_page_settings").serialize(),
					"_wpnonce": 	admindata.settings,	
				};
				jQuery.ajax({					
					url : ajaxurl,					 
...
function listfoliopro_update_email_settings(){
				"use strict";
				var search_params={
					"action"  : 	"listfoliopro_update_email_setting",
...
function listfoliopro_update_account_settings(){
				"use strict";
				var search_params={
					"action"  : 	"listfoliopro_update_account_setting",
...
function listfoliopro_update_protected_settings(){
		"use strict";
		var search_params={
		"action"  : 	"listfoliopro_update_protected_setting",
...
function listfoliopro_protect_select_all(sel_name) {
		"use strict";
...
function listfoliopro_update_profile_fields(){
		"use strict";
		var ajaxurl = admindata.ajaxurl;
		var search_params = {
			"action": 		"listfoliopro_update_profile_fields",
...
function listfoliopro_update_paypal_setting() {
	"use strict";
				var ajaxurl = admindata.ajaxurl;
				// New Block For Ajax*****
				var search_params={
					"action"  : 	"listfoliopro_update_paypal_settings",
...
function  listfoliopro_update_payment_gateways_settings (){
	"use strict";
		var ajaxurl = admindata.ajaxurl;
		
		var search_params = {
			"action": "listfoliopro_gateway_settings_update",
...
function listfoliopro_update_the_package() {
	"use strict";
		var ajaxurl = admindata.ajaxurl;
		var loader_image = admindata.loading_image;
	jQuery("#loading").html(loader_image);
			...
			var search_params={
				"action"  : 	"listfoliopro_update_package",
			...
			jQuery.ajax({					
				...
				data : search_params,
				success : function(response){						
					var url = admindata.listfoliopro_ep_ADMINPATH+"admin.php?page=listfoliopro-settings&packages";
					jQuery(location).attr('href',url);
				}
			});
			
}
function listfoliopro_save_the_package() {
	"use strict";
		var ajaxurl = admindata.ajaxurl;
		var loader_image = admindata.loading_image;
		jQuery("#loading").html(loader_image);
				...
				// New Block For Ajax*****
				var search_params={
					"action"  : 	"listfoliopro_save_package",
					"form_data":	jQuery("#package_form_iv").serialize(),
					"_wpnonce": admindata.packagenonce,	
				};
				jQuery.ajax({					
...
function listfoliopro_package_status_change(status_id,curr_status){
	"use strict";
	status_id =status_id.trim();
	curr_status=curr_status.trim();
	var ajaxurl = admindata.ajaxurl;
	var search_params = {
		"action": 	"listfoliopro_update_package_status",
		"status_id": status_id,	
	...
	jQuery.ajax({
		...
		success: function(response) {   
			if(response.code=='success'){					
				jQuery("#status_"+status_id).html('<button class="btn btn-info btn-xs" onclick="return listfoliopro_package_status_change(\' '+status_id+' \' ,\' '+response.current_st+' \');">'+response.msg+'</button>');
			}
		}
	});
}	
function listfoliopro_change_marker_image(cat_image_id){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {							
				var ajaxurl = admindata.ajaxurl;
				var search_params = {
					"action": 	"listfoliopro_update_map_marker",
...
function listfoliopro_change_cate_image(cat_image_id){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {							
				var ajaxurl =admindata.ajaxurl;
				var search_params = {
					"action": 	"listfoliopro_update_cate_image",
					"attachment_id": attachment.id,
					"category_id": cat_image_id,
					"_wpnonce": admindata.catimage,
				};
...
function listfoliopro_listing_defaultimage_fun(){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {
				...
				jQuery('#listfoliopro_listing_defaultimage').val(attachment.id);
			}
		});
	});
	image_gallery_frame.open(); 
}
function listfoliopro_location_defaultimage_fun(){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {
				...
				jQuery('#listfoliopro_location_defaultimage').val(attachment.id);
			}
		});
	});
	image_gallery_frame.open(); 
}
function listfoliopro_category_defaultimage_fun(){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {
				...
				jQuery('#listfoliopro_category_defaultimage').val(attachment.id);
			}
		});
	});
	image_gallery_frame.open(); 
}
function listfoliopro_banner_defaultimage_fun(){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {
				...
				jQuery('#listfoliopro_banner_defaultimage').val(attachment.id);
			}
		});
	});
	image_gallery_frame.open(); 
...
function listfoliopro_update_dir_setting(){
	"use strict";
	var search_params={
		"action"  : 	"listfoliopro_update_dir_setting",
...
function listfoliopro_update_dir_fields(){
	"use strict";
	var loader_image = admindata.loading_image;
	var search_params = {
		"action": 		"listfoliopro_update_dir_fields",
...
function listfoliopro_update_coupon() {
	"use strict";
	// New Block For Ajax*****
	var search_params={
		"action"  : 	"listfoliopro_update_coupon",
	...
	jQuery.ajax({					
		...
		data : search_params,
		success : function(response){
			var url = admindata.listfoliopro_ep_ADMINPATH+"admin.php?page=listfoliopro-settings&coupon";
			jQuery(location).attr('href',url);
		}
	});
}
...
function listfoliopro_create_coupon() {
	"use strict";
	// New Block For Ajax*****
	var search_params={
		"action"  : 	"listfoliopro_create_coupon",
		"form_data":	jQuery("#coupon_form_iv").serialize(), 
		"form_pac_ids": jQuery("#package_id").val(),
		"_wpnonce": admindata.coupon,
	};
...
function listfoliopro_change_city_image(city_image_id){
	"use strict";
	var image_gallery_frame;
	image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
		// Set the title of the modal.
	...
	image_gallery_frame.on( 'select', function() {
		...
		selection.map( function( attachment ) {
			...
			if ( attachment.id ) {							
				var ajaxurl = admindata.ajaxurl;
				var search_params = {
					"action": 	"listfoliopro_update_city_image",
					"attachment_id": attachment.id,
