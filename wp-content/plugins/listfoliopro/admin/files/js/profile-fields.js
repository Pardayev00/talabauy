...
function listfoliopro_add_listingfield(){
	"use strict";
		...
		wpdatatable.row.add( [
			...
			'<div class="col-md-12 mt-2 "> <button type="button" class="btn btn-primary btn-sm"  onclick="return listfoliopro_remove_listingfield('+profile_data.pi+');"  ><span  class="dashicons dashicons-trash ml-1"></span></button></div></div>', catall
